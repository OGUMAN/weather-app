  ...
  <div class="lang">
    <button class="lang__button" @click="openList">
      <img
        ...
        alt="Select Language"
      />
      <div class="lang__current">{{ language }}</div>
...
export default defineComponent({
  setup() {
    ...
    const { setLanguage } = mapMutations(["setLanguage"]);
    ...
    const languageClick = (language: string): void => {
      setLanguage(language);
      closeList();
    };

    return { isListOpen, openList, closeList, language, languageClick };
  },
});
</script>
